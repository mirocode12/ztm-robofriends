...
const Card = ( { id, name, username, email, showUser } ) => {
    return(
        <div name={id} onClick={showUser} className='transition cursor-pointer hover:scale-105 bg-blue-100 inline-block p-1 m-5 rounded-lg shadow-xl'>
